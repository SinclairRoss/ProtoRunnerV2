    ...
    public void CreateProjectile(Weapon origin)
    {
        ...
        switch(origin.GetProjectileType())
        {
            ...
            case LaserVampire:
                ...
                break;
            case Flare:
                Projectile_Flare flare = new Projectile_Flare(m_Game, origin.GetFirePosition(), origin.GetVelocity(), origin.CalculateProjectileHeading(), origin.GetAltColour(), origin.GetBaseDamage(), origin.GetAffiliation());
