...
public class Matrix
{
    ...
    {
        out.SetVector(m_Elements[12], m_Elements[13], m_Elements[14]);
    }
    ...
    public double GetUp_y()
    {
        return m_Elements[5];
    }

    public double GetUp_z()
    {
        return m_Elements[6];
    }

    // Forward
    public double GetForward_x()
    {
        return m_Elements[8];
    }

    public double GetForward_y()
    {
        return m_Elements[0];
    }

    public double GetForward_z()
    {
