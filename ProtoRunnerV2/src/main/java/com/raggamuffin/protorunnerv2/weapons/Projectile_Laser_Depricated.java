...
public class Projectile_Laser_Depricated extends Projectile
{
    public Projectile_Laser_Depricated(Vector3 position,  Vector3 forward, Colour colour, double baseDamage, AffiliationKey affiliation, ProjectileType type)
    {
        super(position, new Vector3(), forward, colour, baseDamage, affiliation, ModelType.Bit);
    }
    ...
    public Projectile_Laser_Depricated(Weapon origin, GameLogic game)
    {
        super(origin);
