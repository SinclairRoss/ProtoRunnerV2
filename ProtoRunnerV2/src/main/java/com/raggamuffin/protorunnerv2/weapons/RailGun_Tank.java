...
public class RailGun_Tank extends Weapon
{
	...
	public RailGun_Tank(Vehicle anchor, VehicleManager vManager, BulletManager bManager, ParticleManager pManager, GameAudioManager audio, PubSubHub pubSub)
	{
		...
		m_ProjectileTemplate = new ProjectileTemplate(this, m_Anchor.GetVehicleInfo(), ModelType.RailSlug, GetAffiliation(),
							   ...
							   ProjectileBehaviourType.Detonate, m_ParticleManager, m_BulletManager, audio, vManager, pubSub);
