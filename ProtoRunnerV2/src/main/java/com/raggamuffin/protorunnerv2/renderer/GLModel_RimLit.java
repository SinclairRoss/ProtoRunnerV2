...
public class GLModel_RimLit extends GLModel
{
    ...
    public void InitialiseModel(float[] projMatrix, Vector3 eye)
    {
        ...
        GLES20.glUniform3f(m_EyePosHandle, (float)eye.X, (float)eye.Y, (float)eye.Z);
    }
    ...
    protected void InitShaders()
    {
        ...
        int vertexShaderHandler = loadShader(GLES20.GL_VERTEX_SHADER,Shaders.vertexShader_RIMLIT, "Rimlit vertex");
        int fragmentShaderHandler = loadShader(GLES20.GL_FRAGMENT_SHADER,Shaders.fragmentShader_RIMLIT, "Rimlit fragment");
