...
public class GLModel_PhasedObject extends GLModel
{
    ...
    public GLModel_PhasedObject(float[] vertices)
    {
    ...
    public void Draw(GameObject obj)
    {
        ...
        GLES20.glUniform1f(m_RollHandle, 0);//(float) obj.GetRoll());
    ...
    protected void InitShaders()
    {
        ...
        int fragmentShaderHandler = loadShader(GLES20.GL_FRAGMENT_SHADER,Shaders.fragmentShader_PHASED);
