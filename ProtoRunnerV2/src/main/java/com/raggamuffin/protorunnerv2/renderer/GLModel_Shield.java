...
//
    ...
    protected void InitShaders()
    {
        ...
        int vertexShaderHandler = loadShader(GLES31.GL_VERTEX_SHADER,Shaders.vertexShader_SHIELD, "Shield vertex");
        int fragmentShaderHandler = loadShader(GLES31.GL_FRAGMENT_SHADER,Shaders.fragmentShader_SHIELD, "Shield fragment");
