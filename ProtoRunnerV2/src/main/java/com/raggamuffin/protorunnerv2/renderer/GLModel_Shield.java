...
public class GLModel_Shield extends GLModel
{
    ...
    public GLModel_Shield(float[] vertices)
    {
    ...
    protected void InitShaders()
    {
        ...
        int vertexShaderHandler = loadShader(GLES20.GL_VERTEX_SHADER,Shaders.vertexShader_SHIELD, "Shield vertex");
        int fragmentShaderHandler = loadShader(GLES20.GL_FRAGMENT_SHADER,Shaders.fragmentShader_SHIELD, "Shield fragment");
