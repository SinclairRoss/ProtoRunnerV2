...
public class UIScreen_NewToGame extends UIScreen
{
    private int m_Index;
    ...
    public UIScreen_NewToGame(GameLogic Game, UIManager uiManager)
    {
    ...
    public void Create()
    {
        ...
        m_Continue.GetFont().SetColour(cManager.GetPrimaryColour());
