...
public class HighScorePickerScreen extends UIScreen
{
    ...
    public HighScorePickerScreen(GameLogic game, UIManager uiManager)
    {
    ...
    public void Create()
    {
        ...
        m_HighScoreButton = CreateButton(context.getString(R.string.highscore_points_button), PublishedTopics.HighScorePressed);
        m_HighTimeButton = CreateButton(context.getString(R.string.highscore_time_button), PublishedTopics.HighTimePressed);
    }
